...
export const BringDataIcon = memo(forwardRef(function BringDataIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="BringData" {...props} />
}))
