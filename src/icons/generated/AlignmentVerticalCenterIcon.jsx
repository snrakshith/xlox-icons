...
export const AlignmentVerticalCenterIcon = memo(forwardRef(function AlignmentVerticalCenterIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AlignmentVerticalCenter" {...props} />
}))
