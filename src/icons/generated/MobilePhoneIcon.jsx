...
export const MobilePhoneIcon = memo(forwardRef(function MobilePhoneIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="MobilePhone" {...props} />
}))
