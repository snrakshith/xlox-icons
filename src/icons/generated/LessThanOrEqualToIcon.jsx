...
export const LessThanOrEqualToIcon = memo(forwardRef(function LessThanOrEqualToIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LessThanOrEqualTo" {...props} />
}))
