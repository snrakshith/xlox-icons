...
export const HorizontalBarChartAscIcon = memo(forwardRef(function HorizontalBarChartAscIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="HorizontalBarChartAsc" {...props} />
}))
