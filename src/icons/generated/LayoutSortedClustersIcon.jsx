...
export const LayoutSortedClustersIcon = memo(forwardRef(function LayoutSortedClustersIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LayoutSortedClusters" {...props} />
}))
