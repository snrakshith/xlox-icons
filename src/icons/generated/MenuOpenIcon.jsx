...
export const MenuOpenIcon = memo(forwardRef(function MenuOpenIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="MenuOpen" {...props} />
}))
