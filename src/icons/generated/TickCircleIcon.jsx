...
export const TickCircleIcon = memo(forwardRef(function TickCircleIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="TickCircle" {...props} />
}))
