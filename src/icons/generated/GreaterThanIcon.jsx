...
export const GreaterThanIcon = memo(forwardRef(function GreaterThanIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="GreaterThan" {...props} />
}))
