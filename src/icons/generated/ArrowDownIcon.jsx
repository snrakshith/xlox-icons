...
export const ArrowDownIcon = memo(forwardRef(function ArrowDownIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ArrowDown" {...props} />
}))
