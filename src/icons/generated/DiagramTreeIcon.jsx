...
export const DiagramTreeIcon = memo(forwardRef(function DiagramTreeIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DiagramTree" {...props} />
}))
