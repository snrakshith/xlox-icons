...
export const CreditCardIcon = memo(forwardRef(function CreditCardIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="CreditCard" {...props} />
}))
