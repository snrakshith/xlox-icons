...
export const CurvedRangeChartIcon = memo(forwardRef(function CurvedRangeChartIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="CurvedRangeChart" {...props} />
}))
