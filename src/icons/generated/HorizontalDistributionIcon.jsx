...
export const HorizontalDistributionIcon = memo(forwardRef(function HorizontalDistributionIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="HorizontalDistribution" {...props} />
}))
