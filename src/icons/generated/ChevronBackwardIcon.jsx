...
export const ChevronBackwardIcon = memo(forwardRef(function ChevronBackwardIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ChevronBackward" {...props} />
}))
