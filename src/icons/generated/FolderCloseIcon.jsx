...
export const FolderCloseIcon = memo(forwardRef(function FolderCloseIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="FolderClose" {...props} />
}))
