...
export const KeyControlIcon = memo(forwardRef(function KeyControlIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="KeyControl" {...props} />
}))
