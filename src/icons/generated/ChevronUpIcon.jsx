...
export const ChevronUpIcon = memo(forwardRef(function ChevronUpIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ChevronUp" {...props} />
}))
