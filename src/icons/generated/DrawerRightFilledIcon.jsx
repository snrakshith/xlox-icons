...
export const DrawerRightFilledIcon = memo(forwardRef(function DrawerRightFilledIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DrawerRightFilled" {...props} />
}))
