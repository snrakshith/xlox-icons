...
export const AlignmentTopIcon = memo(forwardRef(function AlignmentTopIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AlignmentTop" {...props} />
}))
