...
export const StepForwardIcon = memo(forwardRef(function StepForwardIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="StepForward" {...props} />
}))
