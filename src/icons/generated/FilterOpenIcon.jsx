...
export const FilterOpenIcon = memo(forwardRef(function FilterOpenIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="FilterOpen" {...props} />
}))
