...
export const AlignmentBottomIcon = memo(forwardRef(function AlignmentBottomIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AlignmentBottom" {...props} />
}))
