...
export const BanCircleIcon = memo(forwardRef(function BanCircleIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="BanCircle" {...props} />
}))
