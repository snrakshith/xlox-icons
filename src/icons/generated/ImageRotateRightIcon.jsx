...
export const ImageRotateRightIcon = memo(forwardRef(function ImageRotateRightIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ImageRotateRight" {...props} />
}))
