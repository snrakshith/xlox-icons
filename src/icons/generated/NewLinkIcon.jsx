...
export const NewLinkIcon = memo(forwardRef(function NewLinkIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="NewLink" {...props} />
}))
