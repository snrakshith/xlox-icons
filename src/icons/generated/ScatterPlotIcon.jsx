...
export const ScatterPlotIcon = memo(forwardRef(function ScatterPlotIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ScatterPlot" {...props} />
}))
