...
export const InboxUpdateIcon = memo(forwardRef(function InboxUpdateIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="InboxUpdate" {...props} />
}))
