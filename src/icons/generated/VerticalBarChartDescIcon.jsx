...
export const VerticalBarChartDescIcon = memo(forwardRef(function VerticalBarChartDescIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="VerticalBarChartDesc" {...props} />
}))
