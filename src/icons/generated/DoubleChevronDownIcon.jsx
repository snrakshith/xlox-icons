...
export const DoubleChevronDownIcon = memo(forwardRef(function DoubleChevronDownIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DoubleChevronDown" {...props} />
}))
