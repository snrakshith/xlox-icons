...
export const AreaOfInterestIcon = memo(forwardRef(function AreaOfInterestIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AreaOfInterest" {...props} />
}))
