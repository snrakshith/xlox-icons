...
export const LayoutGridIcon = memo(forwardRef(function LayoutGridIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LayoutGrid" {...props} />
}))
