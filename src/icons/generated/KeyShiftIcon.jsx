...
export const KeyShiftIcon = memo(forwardRef(function KeyShiftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="KeyShift" {...props} />
}))
