...
export const ThListIcon = memo(forwardRef(function ThListIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ThList" {...props} />
}))
