...
export const DocumentShareIcon = memo(forwardRef(function DocumentShareIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DocumentShare" {...props} />
}))
