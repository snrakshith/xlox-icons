...
export const DoughnutChartIcon = memo(forwardRef(function DoughnutChartIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DoughnutChart" {...props} />
}))
