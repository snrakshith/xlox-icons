...
export const ModalFilledIcon = memo(forwardRef(function ModalFilledIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ModalFilled" {...props} />
}))
