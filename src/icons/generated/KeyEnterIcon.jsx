...
export const KeyEnterIcon = memo(forwardRef(function KeyEnterIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="KeyEnter" {...props} />
}))
