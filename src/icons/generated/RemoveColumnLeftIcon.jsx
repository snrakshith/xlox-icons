...
export const RemoveColumnLeftIcon = memo(forwardRef(function RemoveColumnLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="RemoveColumnLeft" {...props} />
}))
