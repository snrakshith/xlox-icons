...
export const ArrowLeftIcon = memo(forwardRef(function ArrowLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ArrowLeft" {...props} />
}))
