...
export const LeftJoinIcon = memo(forwardRef(function LeftJoinIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LeftJoin" {...props} />
}))
