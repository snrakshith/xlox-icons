...
export const MobileVideoIcon = memo(forwardRef(function MobileVideoIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="MobileVideo" {...props} />
}))
