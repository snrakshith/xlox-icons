...
export const CubeAddIcon = memo(forwardRef(function CubeAddIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="CubeAdd" {...props} />
}))
