...
export const RemoveColumnIcon = memo(forwardRef(function RemoveColumnIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="RemoveColumn" {...props} />
}))
