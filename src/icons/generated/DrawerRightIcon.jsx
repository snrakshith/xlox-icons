...
export const DrawerRightIcon = memo(forwardRef(function DrawerRightIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DrawerRight" {...props} />
}))
