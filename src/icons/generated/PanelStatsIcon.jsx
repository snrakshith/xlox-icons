...
export const PanelStatsIcon = memo(forwardRef(function PanelStatsIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="PanelStats" {...props} />
}))
