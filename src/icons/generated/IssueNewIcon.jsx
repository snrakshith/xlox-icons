...
export const IssueNewIcon = memo(forwardRef(function IssueNewIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="IssueNew" {...props} />
}))
