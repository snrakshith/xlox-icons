...
export const RemoveRowTopIcon = memo(forwardRef(function RemoveRowTopIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="RemoveRowTop" {...props} />
}))
