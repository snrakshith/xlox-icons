...
export const FastForwardIcon = memo(forwardRef(function FastForwardIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="FastForward" {...props} />
}))
