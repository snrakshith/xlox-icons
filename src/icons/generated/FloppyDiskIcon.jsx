...
export const FloppyDiskIcon = memo(forwardRef(function FloppyDiskIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="FloppyDisk" {...props} />
}))
