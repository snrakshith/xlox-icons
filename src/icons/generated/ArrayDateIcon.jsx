...
export const ArrayDateIcon = memo(forwardRef(function ArrayDateIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ArrayDate" {...props} />
}))
