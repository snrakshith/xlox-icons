...
export const VerticalDistributionIcon = memo(forwardRef(function VerticalDistributionIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="VerticalDistribution" {...props} />
}))
