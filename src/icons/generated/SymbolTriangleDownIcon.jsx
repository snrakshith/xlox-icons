...
export const SymbolTriangleDownIcon = memo(forwardRef(function SymbolTriangleDownIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="SymbolTriangleDown" {...props} />
}))
