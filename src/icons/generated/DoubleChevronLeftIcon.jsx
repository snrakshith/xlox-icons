...
export const DoubleChevronLeftIcon = memo(forwardRef(function DoubleChevronLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DoubleChevronLeft" {...props} />
}))
