...
export const CodeBlockIcon = memo(forwardRef(function CodeBlockIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="CodeBlock" {...props} />
}))
