...
export const OneToOneIcon = memo(forwardRef(function OneToOneIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="OneToOne" {...props} />
}))
