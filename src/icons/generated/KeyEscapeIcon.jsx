...
export const KeyEscapeIcon = memo(forwardRef(function KeyEscapeIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="KeyEscape" {...props} />
}))
