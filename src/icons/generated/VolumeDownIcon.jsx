...
export const VolumeDownIcon = memo(forwardRef(function VolumeDownIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="VolumeDown" {...props} />
}))
