...
export const FilterKeepIcon = memo(forwardRef(function FilterKeepIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="FilterKeep" {...props} />
}))
