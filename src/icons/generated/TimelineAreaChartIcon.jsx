...
export const TimelineAreaChartIcon = memo(forwardRef(function TimelineAreaChartIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="TimelineAreaChart" {...props} />
}))
