...
export const AddLocationIcon = memo(forwardRef(function AddLocationIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AddLocation" {...props} />
}))
