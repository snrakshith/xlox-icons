...
export const GridViewIcon = memo(forwardRef(function GridViewIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="GridView" {...props} />
}))
