...
export const InfoSignIcon = memo(forwardRef(function InfoSignIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="InfoSign" {...props} />
}))
