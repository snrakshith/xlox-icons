...
export const RegressionChartIcon = memo(forwardRef(function RegressionChartIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="RegressionChart" {...props} />
}))
