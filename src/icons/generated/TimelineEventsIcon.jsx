...
export const TimelineEventsIcon = memo(forwardRef(function TimelineEventsIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="TimelineEvents" {...props} />
}))
