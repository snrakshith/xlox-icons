...
export const SmallCrossIcon = memo(forwardRef(function SmallCrossIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="SmallCross" {...props} />
}))
