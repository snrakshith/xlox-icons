...
export const HorizontalBarChartDescIcon = memo(forwardRef(function HorizontalBarChartDescIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="HorizontalBarChartDesc" {...props} />
}))
