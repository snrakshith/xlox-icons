...
export const LogOutIcon = memo(forwardRef(function LogOutIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LogOut" {...props} />
}))
