...
export const AppHeaderIcon = memo(forwardRef(function AppHeaderIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AppHeader" {...props} />
}))
