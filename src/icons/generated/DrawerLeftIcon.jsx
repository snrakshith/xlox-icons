...
export const DrawerLeftIcon = memo(forwardRef(function DrawerLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DrawerLeft" {...props} />
}))
