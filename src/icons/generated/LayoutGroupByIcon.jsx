...
export const LayoutGroupByIcon = memo(forwardRef(function LayoutGroupByIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LayoutGroupBy" {...props} />
}))
