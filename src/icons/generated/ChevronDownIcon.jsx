...
export const ChevronDownIcon = memo(forwardRef(function ChevronDownIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ChevronDown" {...props} />
}))
