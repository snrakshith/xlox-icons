...
export const DoubleChevronRightIcon = memo(forwardRef(function DoubleChevronRightIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DoubleChevronRight" {...props} />
}))
