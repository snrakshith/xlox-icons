...
export const RemoveRowBottomIcon = memo(forwardRef(function RemoveRowBottomIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="RemoveRowBottom" {...props} />
}))
