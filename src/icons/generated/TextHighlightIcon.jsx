...
export const TextHighlightIcon = memo(forwardRef(function TextHighlightIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="TextHighlight" {...props} />
}))
