...
export const CircleArrowLeftIcon = memo(forwardRef(function CircleArrowLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="CircleArrowLeft" {...props} />
}))
