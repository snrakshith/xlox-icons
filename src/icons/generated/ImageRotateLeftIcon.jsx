...
export const ImageRotateLeftIcon = memo(forwardRef(function ImageRotateLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ImageRotateLeft" {...props} />
}))
