...
export const CircleArrowUpIcon = memo(forwardRef(function CircleArrowUpIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="CircleArrowUp" {...props} />
}))
