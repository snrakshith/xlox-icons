...
export const ChevronLeftIcon = memo(forwardRef(function ChevronLeftIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ChevronLeft" {...props} />
}))
