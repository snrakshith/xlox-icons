...
export const DoubleCaretHorizontalIcon = memo(forwardRef(function DoubleCaretHorizontalIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DoubleCaretHorizontal" {...props} />
}))
