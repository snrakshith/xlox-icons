...
export const LabTestIcon = memo(forwardRef(function LabTestIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LabTest" {...props} />
}))
