...
export const LayoutLinearIcon = memo(forwardRef(function LayoutLinearIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LayoutLinear" {...props} />
}))
