...
export const DrawerLeftFilledIcon = memo(forwardRef(function DrawerLeftFilledIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="DrawerLeftFilled" {...props} />
}))
