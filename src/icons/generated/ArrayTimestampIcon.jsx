...
export const ArrayTimestampIcon = memo(forwardRef(function ArrayTimestampIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ArrayTimestamp" {...props} />
}))
