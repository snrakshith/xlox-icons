...
export const ThFilteredIcon = memo(forwardRef(function ThFilteredIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ThFiltered" {...props} />
}))
