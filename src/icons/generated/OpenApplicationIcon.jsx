...
export const OpenApplicationIcon = memo(forwardRef(function OpenApplicationIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="OpenApplication" {...props} />
}))
