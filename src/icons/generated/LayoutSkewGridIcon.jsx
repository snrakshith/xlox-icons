...
export const LayoutSkewGridIcon = memo(forwardRef(function LayoutSkewGridIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="LayoutSkewGrid" {...props} />
}))
