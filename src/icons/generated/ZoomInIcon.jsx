...
export const ZoomInIcon = memo(forwardRef(function ZoomInIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ZoomIn" {...props} />
}))
