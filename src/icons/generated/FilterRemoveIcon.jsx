...
export const FilterRemoveIcon = memo(forwardRef(function FilterRemoveIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="FilterRemove" {...props} />
}))
