...
export const AlignmentHorizontalCenterIcon = memo(forwardRef(function AlignmentHorizontalCenterIcon(props, ref) {
  return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="AlignmentHorizontalCenter" {...props} />
}))
